...
export interface HamburgerMenuLeftHeaderProps {
...
export const HamburgerMenuLeftHeader = (
  props: HamburgerMenuLeftHeaderProps,
) => {
  ...
  const getProjectName = () => {
    ...
    return props.projectName ?? snippetName ?? projectNameFromPath
  }
    ...
    <>
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <button
            type="button"
            className="rf-p-2 rf-rounded-md hover:rf-bg-zinc-100 dark:hover:rf-bg-zinc-800 rf-transition-colors rf-flex rf-items-center rf-justify-center"
            aria-label="Menu"
          >
