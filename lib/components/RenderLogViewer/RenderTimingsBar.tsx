      ...
      <div className="rf-relative rf-h-8 rf-flex rf-rounded-sm">
        {orderedRenderPhases.map((phase, index) => {
          ...
          return (
            ...
            >
              <div className="rf-opacity-0 rf-group-hover:rf-opacity-100 rf-transition-opacity rf-absolute rf-bottom-full rf-left-1/2 rf-transform -rf-translate-x-1/2 rf-mb-2 rf-px-2 rf-py-1 rf-text-xs rf-whitespace-nowrap rf-rounded rf-bg-gray-900 rf-text-white rf-pointer-events-none">
